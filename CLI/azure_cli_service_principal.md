...
```
az login
az account set --subscription "Dev_Test Smartbilling Pay-As-You-Go"
...
son [ ~ ]$ az ad app credential reset --id 99629ba2-ea49-4251-8265-0db135fccdd8 --display-name rbac100years --append
